...
Gemini models have default safety settings that can be overridden. If you are 
receiving lots of "Safety Warnings" from your models, you can try tweaking the 
`safetySettings` attribute of the model.
...
Context caching allows you to pass some content to the model once, cache the input 
