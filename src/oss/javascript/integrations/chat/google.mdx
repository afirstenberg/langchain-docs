...
You can use the `googleSearchRetrieval` tool to ground responses with Google Search.
...
You can also ground responses using a specific URL. This is supported 
on some models (e.g. `gemini-2.0-flash`).
